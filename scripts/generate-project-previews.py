...
SPECS = {
    ...
    'wp-security-style-guide-preview.png': {
        ...
        'subtitle': 'A guide for writing about WordPress security with clarity, honesty, and empowerment.',
        'pills': [('Editorial Reference', ACCENT), ('Voice & Tone', GOLD), ('Technical Formatting', GREEN)],
        'left_title': 'What It Sets',
        'left_bullets': [
            ...
            'Formatting rules for code, acronyms, and severity',
        ],
