  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .interior-aside.break-glass-aside::before {
      opacity: 0.72;
      background:
        linear-gradient(115deg, transparent 0 47.6%, rgba(220,240,249,0.44) 48.1%, transparent 48.8%) 78% 18% / 74% 74% no-repeat,
        linear-gradient(144deg, transparent 0 48.2%, rgba(220,240,249,0.34) 48.7%, transparent 49.3%) 76% 18% / 60% 58% no-repeat,
        linear-gradient(87deg, transparent 0 49%, rgba(220,240,249,0.28) 49.5%, transparent 50.1%) 80% 10% / 44% 88% no-repeat,
        linear-gradient(28deg, transparent 0 48.8%, rgba(220,240,249,0.28) 49.3%, transparent 49.9%) 77% 26% / 66% 42% no-repeat,
        linear-gradient(171deg, transparent 0 48.8%, rgba(220,240,249,0.22) 49.2%, transparent 49.8%) 80% 14% / 38% 72% no-repeat,
        linear-gradient(58deg, transparent 0 48.9%, rgba(220,240,249,0.18) 49.4%, transparent 50%) 70% 8% / 34% 58% no-repeat;
    }
    .interior-aside.break-glass-aside::after {
      opacity: 0.9;
      background:
