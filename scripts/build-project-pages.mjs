  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .interior-aside.break-glass-aside {
      background:
        radial-gradient(circle at 82% 18%, rgba(255,255,255,0.18), transparent 0 22px),
        linear-gradient(180deg, rgba(2,7,12,0.99), rgba(7,14,22,0.98));
      border-color: rgba(220,240,249,0.28);
      box-shadow:
    ...
    .interior-aside.break-glass-aside::before {
      opacity: 0.95;
      background:
        linear-gradient(115deg, transparent 0 47.5%, rgba(255,255,255,0.72) 48.1%, transparent 48.8%) 78% 18% / 74% 74% no-repeat,
        linear-gradient(144deg, transparent 0 48.1%, rgba(220,240,249,0.56) 48.7%, transparent 49.3%) 76% 18% / 60% 58% no-repeat,
        linear-gradient(87deg, transparent 0 48.9%, rgba(220,240,249,0.46) 49.5%, transparent 50.1%) 80% 10% / 44% 88% no-repeat,
        linear-gradient(28deg, transparent 0 48.7%, rgba(220,240,249,0.44) 49.3%, transparent 49.9%) 77% 26% / 66% 42% no-repeat,
        linear-gradient(171deg, transparent 0 48.7%, rgba(220,240,249,0.36) 49.2%, transparent 49.8%) 80% 14% / 38% 72% no-repeat,
        linear-gradient(58deg, transparent 0 48.8%, rgba(220,240,249,0.3) 49.4%, transparent 50%) 70% 8% / 34% 58% no-repeat;
    }
    .interior-aside.break-glass-aside::after {
      opacity: 1;
      background:
        radial-gradient(circle at 82% 18%, rgba(255,255,255,1), transparent 0 4px),
        radial-gradient(circle at 82% 18%, rgba(220,240,249,0.42), transparent 0 34px),
        radial-gradient(circle at 82% 18%, transparent 0 38px, rgba(220,240,249,0.22) 39px, transparent 41px);
    }
    .interior-aside-heading { margin: 0 0 12px; font-size: 1rem; line-height: 1.3; letter-spacing: -0.01em; }
    .break-glass-aside .interior-aside-heading { color: #fff; text-shadow: 0 1px 0 rgba(0,0,0,0.35); }
