  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .interior-aside.break-glass-aside {
      background:
        radial-gradient(circle at 82% 18%, rgba(255,255,255,0.12), transparent 0 18px),
        linear-gradient(180deg, rgba(5,10,16,0.98), rgba(10,18,28,0.96));
      border-color: rgba(220,240,249,0.18);
      box-shadow:
    ...
    .interior-aside.break-glass-aside::before {
      opacity: 0.9;
      background:
        linear-gradient(115deg, transparent 0 47.4%, rgba(235,247,252,0.62) 48%, transparent 48.9%) 78% 18% / 74% 74% no-repeat,
        linear-gradient(144deg, transparent 0 48%, rgba(220,240,249,0.5) 48.6%, transparent 49.4%) 76% 18% / 60% 58% no-repeat,
        linear-gradient(87deg, transparent 0 48.8%, rgba(220,240,249,0.42) 49.4%, transparent 50.2%) 80% 10% / 44% 88% no-repeat,
        linear-gradient(28deg, transparent 0 48.6%, rgba(220,240,249,0.4) 49.2%, transparent 50%) 77% 26% / 66% 42% no-repeat,
        linear-gradient(171deg, transparent 0 48.6%, rgba(220,240,249,0.32) 49.1%, transparent 49.9%) 80% 14% / 38% 72% no-repeat,
        linear-gradient(58deg, transparent 0 48.7%, rgba(220,240,249,0.26) 49.2%, transparent 50%) 70% 8% / 34% 58% no-repeat;
    }
    .interior-aside.break-glass-aside::after {
      opacity: 1;
      background:
        radial-gradient(circle at 81.8% 18.3%, rgba(255,255,255,0.98) 0 3px, transparent 4px),
        radial-gradient(circle at 82.2% 17.9%, rgba(235,247,252,0.28) 0 10px, transparent 12px),
        radial-gradient(circle at 81.6% 18.4%, transparent 0 16px, rgba(235,247,252,0.3) 17px 19px, transparent 21px),
        radial-gradient(circle at 80.9% 19.2%, transparent 0 28px, rgba(220,240,249,0.24) 29px 31px, transparent 33px),
        radial-gradient(circle at 82.7% 16.8%, transparent 0 40px, rgba(220,240,249,0.2) 41px 43px, transparent 45px),
        radial-gradient(circle at 79.9% 20.1%, transparent 0 8px, rgba(220,240,249,0.2) 9px 10px, transparent 12px),
        conic-gradient(from 18deg at 82% 18%, transparent 0 22deg, rgba(235,247,252,0.22) 22deg 58deg, transparent 58deg 116deg, rgba(220,240,249,0.16) 116deg 148deg, transparent 148deg 218deg, rgba(220,240,249,0.14) 218deg 244deg, transparent 244deg 360deg),
        conic-gradient(from 210deg at 81.3% 18.9%, transparent 0 38deg, rgba(220,240,249,0.14) 38deg 64deg, transparent 64deg 360deg);
    }
    ...
    .why-card-title { margin: 0 0 10px; font-size: 0.9rem; line-height: 1.35; letter-spacing: -0.01em; color: var(--secondary); }
  ...
  <div class="shell" id="site-shell">
    ...
    <main id="main-content" class="stack">
      ...
      <section class="panel section" aria-labelledby="why-title">
        ...
        ${meta.whyCards?.length ? `<div class="why-card-grid">${meta.whyCards.map((card) => `<div class="why-card"><h3 class="why-card-title">${escapeHtml(card.title)}</h3><p>${card.html || escapeHtml(card.text)}</p></div>`).join('')}</div>` : ''}
