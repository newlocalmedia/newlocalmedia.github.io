      ...
      <article class="panel hero">
        <div class="hero-copy">
          ...
          <div class="meta">
            ...
            ${meta.release && !meta.downloadCta ? `<a class="button release-btn" href="${meta.release.url}"><span aria-hidden="true">⬇️</span>&nbsp;Download ${escapeHtml(meta.release.tag)}</a>` : ''}
            ${meta.playground ? `<a class="button demo-btn" href="${meta.playground}"><span aria-hidden="true">🛝</span>&nbsp;Demo</a>` : ''}
